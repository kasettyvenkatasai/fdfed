  ...
  return (
    <div className="vernav">
      <div className="logo">
        ...
        <button id="logout" style={{ cursor: "pointer" }}>
          log out
        </button>
      </div>
      <div className="navbar">
        <ul>
          <li className="ele" style={{ borderRight: "5px solid snow" }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <li className="ele">
            ...
            <Link to="/superadmincolleges">colleges</Link>
          </li>
          <li className="ele">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <Link to='/superadmin_admins'>Admins</Link>
          </li>
        </ul>
      </div>
    </div>
