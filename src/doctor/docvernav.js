        ...
        <div className="doclogo">
            <div className="docuserdetail">
                ...
                <div className="doctextpart" style={{margin: "0" , padding: "0"}}>
                    ...
                    <p style={{margin: "0"}}>helooo</p>
                </div>
            </div>
            <button id="doclogout">log out</button>
        </div>
        <div className="docnavbar">
            <ul className='.Dul'>
                ...
                <li className="docele">
                    ...
                    <Link to="/doctorhome" id="doctor_home">Home</Link>
                    </li>
                <li className="docele">
                    ...
                    <Link to="/doctorbooking" id="Doctor_SS">New Booking</Link>
                </li>
                <li className="docele">
                    ...
                    <Link to="/doctorschedule" id="doctor_schedule">Schedule sessions</Link>
                </li>
                <li className="docele">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
                        <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"/>
                      </svg>
                    <Link to="/doctorpatients" id="patients">My Patients</Link>
                </li>
                <li className="docele">
                    ...
                    <Link to="/doctorsetting" id="doctor_settings">Settings</Link>
                </li>
            </ul>
        </div>
