      ...
      <div>
        ...
        <div className="Slogo">
            <div className="Suserdetail">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="Sbi bi-person-heart" viewBox="0 0 16 16">
                    <path d="M9 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0m-9 8c0 1 1 1 1 1h10s1 0 1-1-1-4-6-4-6 3-6 4m13.5-8.09c1.387-1.425 4.855 1.07 0 4.277-4.854-3.207-1.387-5.702 0-4.276Z"/>
                  </svg>
                <div className="Stextpart"  style={{margin: "0" , padding: "0"}}>
                    <p style={{margin: "0"}}>{/*<%= emailaddress.split('.')[0]%>*/}</p>
                    <p id="Semai" style={{margin: "0"}}></p>
                </div>
            </div>
            <button onClick={logout} id="Slogout">log out</button>
        </div>
        <div className="Snavbar">
            <ul className="Sul">
                <li className="Sele" style={{borderRight:" 5px solid snow"}}>
                    ...
                    <Link to="/studenthome" id="Shome">Home</Link>
                </li>
                <li className="Sele">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="Sbi bi-clipboard2-plus" viewBox="0 0 16 16">
                        <path d="M9.5 0a.5.5 0 0 1 .5.5.5.5 0 0 0 .5.5.5.5 0 0 1 .5.5V2a.5.5 0 0 1-.5.5h-5A.5.5 0 0 1 5 2v-.5a.5.5 0 0 1 .5-.5.5.5 0 0 0 .5-.5.5.5 0 0 1 .5-.5z"/>
                        <path d="M3 2.5a.5.5 0 0 1 .5-.5H4a.5.5 0 0 0 0-1h-.5A1.5 1.5 0 0 0 2 2.5v12A1.5 1.5 0 0 0 3.5 16h9a1.5 1.5 0 0 0 1.5-1.5v-12A1.5 1.5 0 0 0 12.5 1H12a.5.5 0 0 0 0 1h.5a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5z"/>
                        <path d="M8.5 6.5a.5.5 0 0 0-1 0V8H6a.5.5 0 0 0 0 1h1.5v1.5a.5.5 0 0 0 1 0V9H10a.5.5 0 0 0 0-1H8.5z"/>
                      </svg>
                    <Link  to="/studentappointment" id="Sappointment">Appointment</Link>
                </li>
                <li className="Sele">
                    ...
                    <Link to="/studentschedule" id="Sschedule">Schedule sessions</Link>
                </li>
                <li className="Sele">
                    ...
                    <Link to="/studentbooking" id="Sbookings">My Bookings</Link>
                </li>
                <li className="Sele">
                    ...
                    <Link to="/studentsetting" id="Ssettings">Settings</Link>
                </li>
            </ul>
        </div>
        <div className="Siiit" >
            ...
            {/* <p>IIIT SRICITY</p> */}
                ...
                <div className="Stextpart" style={{display: "flex" ,alignItems:"center"}}>
                    <p style={{paddingLeft: "1px"}}>hello</p>
                </div>
            </div>
        </div>
    </div>
